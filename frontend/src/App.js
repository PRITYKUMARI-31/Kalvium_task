...
function App() {
  ...
  const [pdfUrl, setPdfUrl] = useState('/Prity-Kumari.pdf');  // Default PDF file path
  ...
  return (
    ...
    >
      ...
      <h1 className="text-5xl font-serif text-green-300 mb-6 animate__animated animate__fadeIn animate__delay-1s">
        Kalvium Task - Prity Kumari
      </h1>
      <h2 className="text-2xl font-bold text-teal-300 mb-6 animate__animated animate__fadeIn animate__delay-1s">
        Page - {pageNumber}
      </h2>
      
      {/* Document Viewer - showing only one page */}
      <div className="pdf-viewer h-[850px] bg-[#396a60] shadow-xl p-6 mb-6 rounded-xl overflow-hidden">
